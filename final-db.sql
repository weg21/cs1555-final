...
CREATE TABLE messages (
	...
	CONSTRAINT fk_messages_toUserID FOREIGN KEY(toUserID) REFERENCES profile(userID) DEFERRABLE INITIALLY IMMEDIATE,
	CONSTRAINT fk_messages_toGroupID FOREIGN KEY(toGroupID) REFERENCES groups(gID) DEFERRABLE INITIALLY IMMEDIATE,
	CONSTRAINT ic_messages CHECK(toUserID IS NOT NULL OR toGroupID IS NOT NULL) DEFERRABLE INITIALLY IMMEDIATE
);
